...
class Questions
  ...
  class << self
    def create_questions question_introduction
    ...
    def find_asking_member element
      element.at('b/b').inner_text.to_s.strip
    end

    def find_question_texts element
    ...
    def find_question_ids question_texts
